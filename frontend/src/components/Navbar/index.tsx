...
const Navbar = () => {
  ...
  return <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3'>
    {/* Search Bar */}
    ...
    <div className='flex items-center'>
      <button onClick={() => dispatch(setIsDarkMode(!isDarkMode))} className={isDarkMode ? `rounded p-2 dark:hover:bg-gray-700` : `rounded p-2 dark:hover:bg-gray-100`}>
        ...
        <Link
            className={isDarkMode ? `h-min w-min rounded p-2 dark:hover:bg-gray-700` : `h-min w-min rounded p-2 dark:hover:bg-gray-100`}
            href="/settings"
          >
